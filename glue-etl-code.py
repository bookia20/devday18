...
## @type: DataSource
## @args: [database = "nycitytaxianalysis", table_name = "yellow", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "nycitytaxianalysis", table_name = "yellow", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://safipour-data/nytaxi-2017/both"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_options(frame = yellowDynamicFrame, connection_type = "s3", connection_options = {"path": "s3://safipour-data/nytaxi-2017/both"}, format = "parquet", transformation_ctx = "datasink4")


####### Second DataSource

datasource2 = glueContext.create_dynamic_frame.from_catalog(database = "nycitytaxianalysis", table_name = "green", transformation_ctx = "datasource2")

applymapping2 = ApplyMapping.apply(frame = datasource2, mappings = [("vendorid", "long", "vendorid", "long"), ("lpep_pickup_datetime", "string", "pickup_date", "timestamp"), ("lpep_dropoff_datetime", "string", "dropoff_date", "timestamp"), ("store_and_fwd_flag", "string", "store_and_fwd_flag", "string"), ("ratecodeid", "long", "ratecodeid", "long"), ("pulocationid", "long", "pulocationid", "long"), ("dolocationid", "long", "dolocationid", "long"), ("passenger_count", "long", "passenger_count", "long"), ("trip_distance", "double", "trip_distance", "double"), ("fare_amount", "double", "fare_amount", "double"), ("extra", "double", "extra", "double"), ("mta_tax", "double", "mta_tax", "double"), ("tip_amount", "double", "tip_amount", "double"), ("tolls_amount", "double", "tolls_amount", "double"), ("improvement_surcharge", "double", "improvement_surcharge", "double"), ("total_amount", "double", "total_amount", "double"), ("payment_type", "long", "payment_type", "long")], transformation_ctx = "applymapping2")

resolvechoice22 = ResolveChoice.apply(frame = applymapping2, choice = "make_struct", transformation_ctx = "resolvechoice22")

dropnullfields2 = DropNullFields.apply(frame = resolvechoice22, transformation_ctx = "dropnullfields2")

##----------------------------------
#convert to a Spark DataFrame...
greenDF = dropnullfields2.toDF()
...
datasink2 = glueContext.write_dynamic_frame.from_options(frame = greenDynamicFrame, connection_type = "s3", connection_options = {"path": "s3://safipour-data/nytaxi-2017/both"}, format = "parquet", transformation_ctx = "datasink2")
